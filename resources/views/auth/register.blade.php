                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <a href="{{ url('/login/twitter') }}" class="btn btn-twitter float-left" class="btn btn-twitter"><i class="fa fa-twitter"></i> Twitter</a>
                                <a href="{{ url('/login/facebook') }}" class="btn btn-facebook float-left" class="btn btn-facebook"><i class="fa fa-facebook"></i> Facebook</a>
