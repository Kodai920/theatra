        ...
        <form method="GET" action="{{route('search.results')}}" class="ml-auto">
            ...
            <div class="row">
                <div class="col-md-6 mt-2">
                    <input class="mx-1" type="radio" value="mr" name="search" checked>タイトル
                    <input class="mx-1" type="radio" value="cr" name="search">カテゴリ
                    <input class="mx-1" type="radio" value="conr" name="search">作成国
                </div>
