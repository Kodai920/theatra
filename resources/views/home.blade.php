...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="my-5">
            ...
            <div class="row">
                <div class="col-4">
                    <a href="{{route('categories.show',[$categories->id(61)])}}" class="movie-image">
            ...
            <a href="{{route('categories.index')}}" class="btn btn-success" style="background-color:#E40914;">すべてのカテゴリを見る</a>
        </div>
        <hr color="#131313">
        <div class="my-5">
