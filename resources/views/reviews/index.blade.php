...
<div class="card-body">
    ...
    <div class="wrapper">
        <div class="row">
            <div class="col-6">
                <div class="float-left"><img src="{{asset("uploads/avator/".$user->profile->avator)}}" alt="" style="height:80px; width:80px;"></div>
                <div class="mx-3">
...
<div>
    ...
    @foreach($user->reviews->assortBy('created_at') as $review)
    <div class="card mb-2">
