    ...
    <div class="wrapper">
        ...
        <div>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img class="welcome-photos d-block mx-auto" src="uploads/welcomes/netflixwel.jpg" alt="">
                    </div>
                    <div class="col-md-6">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img class="welcome-photos d-block mx-auto" src="uploads/welcomes/cuttool.jpg" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img class="welcome-photos d-block mx-auto" src="uploads/welcomes/filmtwo.jpg" alt="">
                </div>
                <div class="col-md-6">
                    <div class="icons">
        ...
        <div class="container my-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img class="welcome-photos d-block mx-auto" src="uploads/welcomes/snstwitter.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
